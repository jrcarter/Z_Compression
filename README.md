...
It is reasonably straightforward to define Out_Of_Data and Next to decompress data in Zlib format. See programs Z_Decomp and Arch for examples.
...
A more complete demonstration of both compression and decompression is given in the [Arch](https://github.com/jrcarter/Arch) archive manager.
